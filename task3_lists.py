...
# a) Create a list called game_names containing only the names of all 20 games
game_names = []
...
# b) Append a new game to video_game_sales and print the updated length
...
# c) Create a tuple called dataset_info and print it
