...
if total_na_sales > total_jp_sales:
    print("   Result: North America had higher sales.")
elif total_jp_sales > total_na_sales:
    print("   Result: Japan had higher sales.")
else:
    print("   Result: Both regions had identical sales totals.")
print("-" * 40)
...
print(f"   Total Number of Nintendo Games: {len(nintendo_games)}")
